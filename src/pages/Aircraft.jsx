...
const categories = [
  {
    name: 'Light Jet',
    img: 'https://images.unsplash.com/photo-1518307746-4e8a4360a636?q=80&w=2000&auto=format&fit=crop',
  ...
  {
    name: 'Mid-Size Jet',
    img: 'https://images.unsplash.com/photo-1556706998-81fce52b58dd?q=80&w=2000&auto=format&fit=crop',
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1504197639813-76941188ec1b?q=80&w=2000&auto=format&fit=crop',
          ...
          {categories.map((c) => (
            <Card key={c.name}>
              <div className="relative">
                <img src={c.img} alt={c.name} className="rounded-xl mb-4 h-40 w-full object-cover" loading="lazy" />
